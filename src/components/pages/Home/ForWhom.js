...
function ForWhom() {
    ...
    return (
        <section className='bg-bodyBackground pt-[50px] md:pt-[30px] pb-[80px] relative overflow-hidden'>
            ...
            <div className="container">
                ...
                <div className="grid grid-cols-[repeat(4,auto)] md:grid-cols-[repeat(2,auto)] md:justify-center sm:grid-cols-[repeat(2,auto)]">
                    {
                        forWhom && forWhom.map((element, value) => {
                            return (
                                <div key={value} className="max-w-[284px] rounded-r-[20px] rounded-br-[20px] rounded-bl-[20px] card px-[10px] pt-[10px] pb-[35px] mb-[40px] md:mb-[20px] sm:mb-[15px] md:mr-[20px] sm:mr-[20px] bg-white">
