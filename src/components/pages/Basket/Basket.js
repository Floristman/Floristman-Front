...
function Basket() {
  ...
  return (
    <div>
      ...
      <div className='bg-bodyBackground  mt-[150px] pt-[35px] pb-[50px]'>
        <div className="container relative z-[11]">
          ...
          <div>
            <h2 className='text-[48px] font-[600] leading-[59px] text-[#272626] text-center mb-[36px] mt-[50px]'>Сумма заказов</h2>
            <div className="flex justify-between">
              <h2 className='text-[24px] font-[500] leading-[29px] text-[#272626]'>Общая сумма заказов:</h2>
              <p className='text-[18px] font-[500] leading-[22px] text-[#272626]'>{price} грн</p>
            </div>
            <div className="flex justify-between mt-[18px] mb-[64px]">
              <h2 className='text-[24px] font-[500] leading-[29px] text-[#272626]'>Способ оплаты:</h2>
              <div>
                <div className="flex justify-end items-center gap-[10px]">
                  <div onClick={() => handleCheckPayment('paymentOne')} className={`${paymentOne ? 'border-[#FD4F79]' : 'border-[#272626]'}  border-[0.4px] cursor-pointer  rounded-[50%] w-[22px] h-[22px] flex items-center justify-center`}>
                    <span className={`${paymentOne ? 'bg-[#FD4F79]' : 'bg-[#FFF6F2]'} border-[3px] border-[#FFF6F2] rounded-[50%] w-full h-full`}></span>
                  </div>
                  <span className={`${paymentOne ? 'text-[#FD4F79]' : 'text-[#272626]'} text-[18px] font-[500] leading-[22px]`}>Оплата при доставке</span>
                </div>
                <div className="flex justify-end items-center gap-[10px] my-[5px]">
                  <div onClick={() => handleCheckPayment('paymentTwo')} className={`${paymentTwo ? 'border-[#FD4F79]' : 'border-[#272626]'}  border-[0.4px] cursor-pointer rounded-[50%] w-[22px] h-[22px] flex items-center justify-center`}>
                    <span className={`${paymentTwo ? 'bg-[#FD4F79]' : 'bg-[#FFF6F2]'} border-[3px] border-[#FFF6F2] rounded-[50%] w-full h-full`}></span>
                  </div>
                  <span className={`${paymentTwo ? 'text-[#FD4F79]' : 'text-[#272626]'} text-[18px] font-[500] leading-[22px]`}>Оплата картой</span>
                </div>
                <div className="flex justify-end items-center gap-[10px]">
                  <div onClick={() => handleCheckPayment('paymentThree')} className={`${paymentThree ? 'border-[#FD4F79]' : 'border-[#272626]'}  border-[0.4px] cursor-pointer  rounded-[50%] w-[22px] h-[22px] flex items-center justify-center`}>
                    <span className={`${paymentThree ? 'bg-[#FD4F79]' : 'bg-[#FFF6F2]'} border-[3px] border-[#FFF6F2] rounded-[50%] w-full h-full`}></span>
                  </div>
                  <span className={`${paymentThree ? 'text-[#FD4F79]' : 'text-[#272626]'} text-[18px] font-[500] leading-[22px]`}>Оплата на карту ПриватБанк</span>
                </div>
              </div>
            </div>
            <div className="flex justify-between">
              <div className="grid grid-cols-[repeat(2,max-content)]">
                <h2 className='text-[24px] font-[500] leading-[29px] text-[#272626] mr-[18px]'>Доставка:</h2>
                <h2 className='text-[24px] font-[500] leading-[29px] text-[#272626] '>Самовызов:</h2>
                <h2 className='col-[2/2] text-[24px] font-[500] leading-[29px] text-[#272626] '>Курьером:</h2>
              </div>
              <div className='grid'>
                <div className="flex justify-end items-center gap-[10px]">
                  <div onClick={() => handleCheckDelivery('deliveryOne')} className={`${deliveryOne ? 'border-[#FD4F79]' : 'border-[#272626]'}  border-[0.4px]  rounded-[50%] w-[22px] h-[22px] flex items-center justify-center`}>
                    <span className={`${deliveryOne ? 'bg-[#FD4F79]' : 'bg-[#FFF6F2]'} border-[3px] border-[#FFF6F2] cursor-pointer rounded-[50%] w-full h-full`}></span>
                  </div>
                  <span className={`${deliveryOne ? 'text-[#FD4F79]' : 'text-[#272626]'} text-[18px] font-[500] leading-[22px]`}>Бесплатно</span>
                </div>
                <div className="flex justify-end items-center gap-[10px]">
                  <div onClick={() => handleCheckDelivery('deliveryTwo')} className={`${deliveryTwo ? 'border-[#FD4F79]' : 'border-[#272626]'}  border-[0.4px] cursor-pointer rounded-[50%] w-[22px] h-[22px] flex items-center justify-center`}>
                    <span className={`${deliveryTwo ? 'bg-[#FD4F79]' : 'bg-[#FFF6F2]'} border-[3px] border-[#FFF6F2] rounded-[50%] w-full h-full`}></span>
                  </div>
                  <span className={`${deliveryTwo ? 'text-[#FD4F79]' : 'text-[#272626]'} text-[18px] font-[500] leading-[22px]`}>000 грн</span>
                </div>
              </div>
            </div>
            <div className="flex justify-between my-[18px]">
              <h2 className='text-[24px] font-[500] leading-[29px] text-[#272626] mr-[18px]'>Скидка:</h2>
              <p className='text-[18px] font-[500] leading-[22px] text-[#272626]'>-10%</p>
            </div>
            <div className="flex justify-between">
              <h2 className='text-[24px] font-[500] leading-[29px] text-[#272626] mr-[18px]'>Итого к оплате:</h2>
              <p className='text-[24px] font-[700] leading-[29px] text-[#7EA048]'>{price} грн</p>
            </div>
          </div>
          <div>
            <h2 className='text-[48px] font-[600] leading-[59px] text-[#272626] text-center mb-[36px] mt-[80px]'>Оформление заказа</h2>
            <div className="flex flex-col max-w-[770px] mx-auto justify-center gap-[20px]">
              <input className='py-[24px] px-[45px] outline-none text-[36px] rounded-[45px]' type="text" placeholder='Имя' />
              <input className='py-[24px] px-[45px] outline-none text-[36px] rounded-[45px]' type="number" placeholder='Телефон' />
              <input className='py-[24px] px-[45px] outline-none text-[36px] rounded-[45px]' type="text" placeholder='Адрес доставки' />
            </div>
            <div className='flex justify-center mt-[50px]'>
              <button className='py-[23px] px-[45px] bg-buttonBackground hover:bg-buttonBackgroundHover text-[24px] text-white font-[600] leading-[29px] rounded-[37px]'>Подтверждение заказа</button>
            </div>
          </div>
        </div>
      </div>
