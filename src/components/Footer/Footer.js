...
function Footer() {
  return (
    <footer className='mt-[42px] mb-[50px]'>
      <div className="container">
        ...
        <div className="grid grid-cols-[repeat(4,auto)] gap-x-[16px] gap-y-[24px] mt-[42px] mb-[60px]" >
          {
        ...
        <div className="text-center">
          <h2 className='text-[36px] font-[600] leading-[44px] text-headerText'>Контакты:</h2>
          <div className="flex justify-center items-center gap-[7px] mt-[24px] mb-[6px]">
            <img src={footerTelIcon} alt="" />
            <a href="+749500000000" className='text-[24px] font-[600] leading-[30px] text-headerText'>+749500000000</a>
          </div>
          <div className="flex justify-center items-center gap-[7px]">
            <img src={footerEmailIcon} alt="" />
            <a href="#!" className='text-[24px] font-[600] leading-[30px] text-headerText'>Електоронный_адрес@gmail.com</a>
          </div>
          <div className="flex justify-center items-center gap-[24px] my-[30px]">
          ...
          <p className='text-[24px] font-[400] leading-[30px] text-headerText'>©2021. Все права защищены </p>
        </div>
      </div>
    </footer>
  )
