export const style  = {
    ...
    header:'bg-white relative pt-[330px] pb-[190px] xs:pt-[122px] xs:pb-[50px] sm:pt-[150px] sm:pb-[100px] md:pt-[220px] md:pb-[120px]',
    ...
    personalInpCss:'py-[5px] pl-[14px] bg-white rounded-[17px] text-[18px] leading-[21px] text-[#8e8d6f]  font-[400] outline-none',
